...
import com.meditec.resources.Chat;
...
public class Finder {
	...
	public static JSONObject get_chat_msg(){
		return get_chat_msg(Chat.getList(), new JSONObject());
	}
	
	private static JSONObject get_chat_msg(ArrayList<String> list, JSONObject json){
